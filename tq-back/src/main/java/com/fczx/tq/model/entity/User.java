package com.fczx.tq.model.entity;
...
public class User implements Serializable {
    ...
    public String  getUserRoleName(String userRole){
      switch (userRole){
          case "admin" :this.userRoleName="管理员";break;
          case "user"  :this.userRoleName="用户";break;
          case "ban" :this.userRoleName="被禁";break;
          case "vip" :this.userRoleName="会员";break;
      }
