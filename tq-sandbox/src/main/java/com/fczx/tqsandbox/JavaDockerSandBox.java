...
public class JavaDockerSandBox extends JavaSandBoxTemplate {
    private static final String INIT_FLAG_FILE = System.getProperty("user.dir")+File.separator+"first_init_flag.txt";
    ...
    public List<ExecuteMessage> runFile(File userCodeFile, List<String> inputCaseList) {
        ...
        File initFlagFile = new File(INIT_FLAG_FILE);
        // 拉取镜像
        ...
        if (!initFlagFile.exists()) {
            ...
            try {
                pullImageCmd
                        ...
                        .awaitCompletion();
                FileWriter writer = new FileWriter(INIT_FLAG_FILE);
                ...
                System.err.println("无法创建初始化标记文件：" + e.getMessage());
            }
        } else {
